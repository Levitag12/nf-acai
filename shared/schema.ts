...
export const zodDocumentStatusEnum = z.enum(["DELIVERED", "RECEIPT_CONFIRMED", "RETURN_SENT", "COMPLETED", "ARCHIVED"]);
...
export const insertUserSchema = z.object({
  ...
  role: zodUserRoleEnum.optional(),
});

export const insertDocumentSchema = z.object({
  title: z.string(),
  status: zodDocumentStatusEnum.optional(),
